  ...
  return (
    <>
      <div className="min-h-screen pb-20">
        ...
        {/* Mobile Menu */}
        <div
          className={`fixed inset-0 z-[100] bg-black/70 text-black backdrop-blur flex flex-col items-center justify-center text-lg gap-8 lg:hidden transition-transform duration-300 ${
        ...
        >
          ...
          <div className="flex gap-2">
            ...
            <a
              href=""
              className="px-6 py-2 border border-white active:scale-95 hover:bg-slate-50 transition-all rounded-full text-white hover:text-white/80"
            >
              Login
            </a>
          </div>
          <button
            ...
            className="active:ring-3 active:ring-white aspect-square absolute top-5 right-5 size-10 p-1 items-center justify-center bg-green-600 hover:bg-green-700 transition text-white rounded-md flex"
          >
            X
          </button>
        </div>
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          ...
          {/* Avatars + Stars */}
          <div className="flex items-center mt-14 md:mt-10 lg:mt-24">
          ...
          {/* Headline + CTA */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold max-w-5xl text-center mt-6 md:mt-4 md:leading-[70px]">
