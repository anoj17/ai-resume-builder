...
const Footer = () => {
  return (
    <>
      ...
      <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 mt-14 bg-gradient-to-r from-white via-green-200/60 to-white">
        ...
        <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
          ...
          <div className="flex items-center gap-4 mt-3">
            <a
              ...
              rel="noreferrer"
            >
              <Instagram className="size-5 hover:text-green-500" />
            </a>
            <a
            ...
            <a
              ...
              rel="noreferrer"
            >
              <Facebook className="size-5 hover:text-green-500" />
            </a>
          </div>
