...
const Features = () => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="flex flex-col md:flex-row items-center md:mt-10 justify-center xl:-mt-10">
        <img
          className="w-full md:w-3/5 lg:w-full xl:-ml-32 lg:max-w-2xl"
          src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/features/group-image-1.png"
          alt=""
        />
        <div
          className="px-4 md:px-0 md:mr-2"
